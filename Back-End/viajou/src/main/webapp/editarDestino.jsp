...
<body>
	...
	<div id="centerbar">
		<h1>Edite as informações sobre o destino abaixo</h1>
	</div>
	<div id="main1">
	<form name="frmDestino" action="updateDestino">
		<table>
			<tr>
				<td><input type="text" name="idDestino" id="caixa3" readonly value="<%out.print(request.getAttribute("idDestino")); %>"></td>
			</tr>
			<tr>
				<td><input type="text" name="endereco" class="Caixa1" value="<%out.print(request.getAttribute("endereco")); %>"></td>
			</tr>
			<tr>
				<td><input type="text" name="nome" class="Caixa2" value="<%out.print(request.getAttribute("nome")); %>"></td>
			</tr>
			<tr>
				<td><input type="text" name="preco" class="Caixa2" value="<%out.print(request.getAttribute("preco")); %>"></td>
			</tr>
			<tr>
				<td><input type="text" name="qtdVagas" class="Caixa1" value="<%out.print(request.getAttribute("qtdVagas")); %>"></td>
			</tr>
		</table>
	...
	<script src="scripts/validaDestino.js"></script>
</body>
</html>
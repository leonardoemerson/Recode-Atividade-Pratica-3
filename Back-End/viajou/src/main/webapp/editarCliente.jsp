...
<body>
	...
	<form name="frmCliente" action="updateCliente">
		<table>
			<tr>
				<td><input type="text" name="idCliente" id="caixa3" readonly value="<%out.print(request.getAttribute("idCliente")); %>"></td>
			</tr>
			<tr>
				<td><input type="text" name="nome" class="Caixa1" value="<%out.print(request.getAttribute("nome")); %>"></td>
			</tr>
			<tr>
				<td><input type="text" name="cpf" class="Caixa2" value="<%out.print(request.getAttribute("cpf")); %>"></td>
			</tr>
			<tr>
				<td><input type="text" name="rg" class="Caixa2" value="<%out.print(request.getAttribute("rg")); %>"></td>
			</tr>
			<tr>
	...
	<script src="scripts/validaCliente.js"></script>
</body>
</html>